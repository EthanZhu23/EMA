...
public class FifthPage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message = intent_previous.getIntegerArrayListExtra("Fourth_Page");
    ...
    public void onClick(View v){
        ...
        intent.putIntegerArrayListExtra("Fifth_Page", message);
